...
struct ChatView: View {
    ...
    private var wallpaperBackground: some View {
        ...
        return ZStack {
            if wallpaperName == "defaultDark" {
                ...
                if let indexString = wallpaperName.split(separator: "_").last,
                   let index = Int(indexString),
                   themeManager.userWallpapers.indices.contains(index) {
    ...
    var messageInputView: some View {
        HStack(spacing: 3) {
            ...
            .buttonStyle(.plain);TextField("Сообщение", text: $messageText, axis: .vertical)
